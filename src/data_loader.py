...
def get_paths(train_triplets, valid_triplets, test_triplets):
    def _get_pickle_path(dir, pathtype, length):
        return dir + pathtype + '_paths_' + length + '.pkl'
    ...
    train_file_paths = _get_pickle_path(directory, 'train', length)
    if os.path.exists(train_file_paths):
        ...
        pickle.dump(valid_paths, open(_get_pickle_path(directory, 'valid', length), 'wb'))
        pickle.dump(test_paths, open(_get_pickle_path(directory, 'test', length), 'wb'))
